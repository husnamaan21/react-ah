...
export default function RedAlice() {
...
var adjustBackgroundPlayback =()=> {
  ...
  console.log(foreground1Movement.getAnimation().effect)
...
useEffect(()=>{
  ...
  setInterval( function() {
    ...
    if (playbackrateRQ > .4) {
      ...
      // console.log("playbackRate", redQueen_alice.getAnimation().playbackRate)  
    } 
    ...
    return (
        ...
        <div className="earth">
          <div id="red-queen_and_alice">
            <img id="red-queen_and_alice_sprite" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/sprite_running-alice-queen_small.png"  alt="Alice and the Red Queen running to stay in place." ref={redQueen_alice.ref}/>
          </div>
        </div>
